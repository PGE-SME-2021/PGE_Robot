// library
/** \file  srial__cmd.cpp
 * This file includes functions that allow writing the data coming from the 
 * raspy nodes in the usb port as well as reading the data in the usb port 
...
/*! \fn int send_serial_V1(int com) 
 *  \brief This function write commands to the motor in the usb port 
 * of the Raspy if these are in a range from 0 to 6.
 *  \param com contains the commennd to be translated and ssent to the port
 */
...
/*! \fn void set_rts(int fd, int actif) 
 * \brief ????????????????????????????????????
 * \param fd ?????????????????????????????????????????
 * \param actif to indicate if the port is active
 */
...
/*! \fn int send_serial_cmd_motor(int com) 
 * \brief ????????????????????????????????????
 * \param com ?????????????????????????????????????????
 */
...
/*! \fn int send_serial_cmd_vitesse_motor( uint8_t a, uint8_t b) 
 * \brief This function write speed and direction commands for the motor in the usb port 
 * \param a ?????????????????????????????????????????
 * \param b ?????????????????????????????????????????
 */
